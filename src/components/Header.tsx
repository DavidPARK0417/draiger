...
export default function Header() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (marketingToolsDropdownRef.current && !marketingToolsDropdownRef.current.contains(event.target as Node)) {
        setIsMarketingToolsOpen(false);
      }
      if (usefulToolsDropdownRef.current && !usefulToolsDropdownRef.current.contains(event.target as Node)) {
  ...
  const isMarketingToolActive = marketingTools.some(tool => pathname === tool.href);
  ...
  useEffect(() => {
    ...
    if (isMarketingToolsOpen && marketingToolsDropdownRef.current) {
      const dropdownElement = marketingToolsDropdownRef.current.querySelector('[data-dropdown-menu]') as HTMLElement;
      if (dropdownElement) {
        console.log('마케팅도구 드롭다운 요소 렌더링됨:', dropdownElement);
        console.log('마케팅도구 드롭다운 위치:', dropdownElement.getBoundingClientRect());
        console.log('마케팅도구 드롭다운 스타일:', window.getComputedStyle(dropdownElement));
      }
    }
  ...
  useEffect(() => {
    ...
    if (isUsefulToolsOpen && usefulToolsDropdownRef.current) {
      const dropdownElement = usefulToolsDropdownRef.current.querySelector('[data-dropdown-menu]') as HTMLElement;
      if (dropdownElement) {
        console.log('유용한도구 드롭다운 요소 렌더링됨:', dropdownElement);
        console.log('유용한도구 드롭다운 위치:', dropdownElement.getBoundingClientRect());
        console.log('유용한도구 드롭다운 스타일:', window.getComputedStyle(dropdownElement));
      }
    }
  }, [isUsefulToolsOpen]);
            ...
            <div className="relative" ref={marketingToolsDropdownRef}>
              <button
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  console.log('마케팅도구 버튼 클릭, 현재 상태:', isMarketingToolsOpen);
            ...
            <div className="relative" ref={usefulToolsDropdownRef}>
              <button
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  console.log('유용한도구 버튼 클릭, 현재 상태:', isUsefulToolsOpen);
